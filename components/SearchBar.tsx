    ...
    >
      ...
      <div className="glass-strong rounded-2xl flex items-center gap-3 px-5 py-4 transition-all duration-200 focus-within:ring-2 focus-within:ring-violet-400/60 focus-within:border-violet-400/40">
        ...
        <button
          type="submit"
          disabled={!q.trim()}
          className="px-4 py-2 rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-600 text-gem-white text-sm font-semibold tracking-wide transition-all duration-200 hover:brightness-110 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
        >
          Check
        </button>
      </div>
